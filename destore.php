...
$rs = mysqli_query($con,$strSQL);
  ...
  <div class='container-fluid'>
   ...
   <tr>
  <td style='padding:10px;' width=100>Store ID</td> 	
   <td width=100>Name of Store</td> 
  <td width=100>Owner of Store</td>
 ...
 { 
print "<tr>"; 
print "<td style='padding:10px;'>" . $row['STORE_ID'] . "</td>";
print "<td>" . $row['NAME_OF_STORE'] . "</td>"; 
print "<td>" . $row['OWNER_OF_STORE'] . "</td>";
			...
			<div class="row">
				<div class="col-lg-6 about-text">
					<h2>Delete Data</h2><br>
						<form action="destore.php" method="post">
	...
	if(isset($_POST['store_ID']))
        {
          ...
          else
          {
          		$id=$_POST["store_ID"];
           		...
           		$sql = "DELETE FROM dbms_project.stores WHERE STORE_ID = '$id'" ;
