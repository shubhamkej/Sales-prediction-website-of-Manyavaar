...
<body>
  ...
  <section class="page-top-section set-bg" data-setbg="img/top-bg.jpg">
    <div class="container">
      <h2>Update Festival Collection</h2>
    </div>
  </section>
...
$rs = mysqli_query($con,$strSQL);
  ...
  <td width=100>Ethnic Wear Price</td> 
  <td width=100>Modern Wear Price</td> 
  </tr>"; 
 while($row = mysqli_fetch_array($rs))
 { 
print "<tr>"; 
print "<td style='padding:10px;'>" . $row['Serial_Festival_Number'] . "</td>"; 
print "<td>" . $row['Ethnic_Price'] . "</td>"; 
print "<td>" . $row['Modern_Price'] . "</td>";  
print "</tr>"; 
} 
print "</table></div>"; 
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 about-text">
          <h2>Add Data</h2><br>
            <form action="upfestival.php" method="post">
            Enter Details of Festival Dress: <br>
            <br><input type = "text" name = "id" placeholder="Serial Number"><br><br>
            <br><input type = "text" name = "eprice" placeholder="Ethnic Dress Price"><br><br>
            <br><input type = "text" name = "mprice" placeholder="Modern Dress Price"><br><br>
            <button type="submit">Submit</button>
        </div>
        <div class="col-lg-6">
          <img src="./img/infes.jpg" alt="">
        </div>
      </div>
    </div>
  </section>
  ...
  if(isset($_POST['id']))
        {
          ...
          else
          {
              ...
              if($mprice==0)
              {  
                  $sql = "UPDATE dbms_project.festival SET Ethnic_Price='$eprice' WHERE Serial_Festival_Number='$id'" ;
              ...
              {  
                  $sql = "UPDATE dbms_project.festival SET Modern_Price='$mprice' WHERE Serial_Festival_Number='$id'" ;
                  if (mysqli_query($connection, $sql)) {
                      echo "Record updated successfully";
                  } else {
                      echo "Error: " . $sql . "<br>" . $connection->error;
