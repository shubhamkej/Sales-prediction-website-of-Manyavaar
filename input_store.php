			...
			<div class="row">
				<div class="col-lg-6 about-text">
					<h2>Add Data</h2><br>
						...
						Enter Details of Store: <br>
						<br><input type = "text" name = "store_ID" placeholder="Store ID"><br><br>
						<br><input type = "text" name = "Name_of_store" placeholder="Name of Store"><br><br>
						<br><input type = "text" name = "owner_of_store" placeholder="Owner of Store"><br><br>
						<br><input type = "text" name = "contact" placeholder="Contact Number"><br><br>
	...
	if(isset($_POST['pincode']))
        {
          ...
          {
          		$id=$_POST["store_ID"];
           		$name=$_POST["Name_of_store"];
				$owner=$_POST["owner_of_store"];
				$contact=$_POST["contact"];
				$pincode=$_POST["pincode"];
           		$sql = "INSERT INTO dbms_project.stores (STORE_ID, NAME_OF_STORE, OWNER_OF_STORE, CONTACT_NUMBER, Pincode) VALUES ( '$id', '$name', '$owner', '$contact', '$pincode')" ;
