		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6 about-text">
					<h2>Add Data</h2><br>
						<form action="sales_record.php" method="post">
						...
						<br><input type = "text" name = "month" placeholder="Month"><br><br>
						<br><input type = "text" name = "pincode" placeholder="City"><br><br>
	...
	if(isset($_POST['pincode']))
        {
          ...
          else
          {
				...
				$pincode=$_POST["pincode"];
           		...
           		$sql = "INSERT INTO dbms_project.sales ( Batch_Number, Monthly_Sales, Time, City_Pincode) VALUES (  '$cID', '$sale', '$month', '$pincode')" ;
