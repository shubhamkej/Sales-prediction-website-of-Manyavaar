		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6 about-text">
					<h2>Add Data</h2><br>
						<form action="Input%20City.php" method="post">
						Enter Details of City: <br>
						<br><input type = "text" name = "city_name" placeholder="Name of City"><br><br>
						<br><input type = "text" name = "No_of_stores" placeholder="Total Stores"><br><br>
	...
	if(isset($_POST['No_of_stores']) && isset($_POST['pincode']))
        {
          ...
          else
          {
				...
				$pincode=$_POST["pincode"];
           		...
           		$sql = "INSERT INTO dbms_project.city (Name_of_City, No_Of_Stores, Pincode) VALUES ( '$name', '$stores', '$pincode')" ;
